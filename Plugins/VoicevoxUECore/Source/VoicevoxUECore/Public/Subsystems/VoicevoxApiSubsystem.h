...
public:
	 ...
	 * @returns AccentPhrase (アクセント句)の配列
	 */
	virtual TArray<FVoicevoxAccentPhrase> SynthesizerReplaceMoraData(TArray<FVoicevoxAccentPhrase> AccentPhrases, VoicevoxStyleId StyleId) { return TArray<FVoicevoxAccentPhrase>(); }
